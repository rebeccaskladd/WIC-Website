...
<body>
    ...
    <div class="wicbits-page">
        <div class="section">
            ...
            <h2>WicBits 2016-2017</h2>
            <div class="wicbits-section">
                <?php
                $directory = "";
                $root = "../../wicbits/2016-2017";
                ...
                echo "<h3 class=\"wicbits-month\">September 2016</h3>";
                foreach ($september as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">October 2016</h3>";
                foreach ($october as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">November 2016</h3>";
                foreach ($november as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">December 2016</h3>";
                foreach ($december as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">January 2017</h3>";
                foreach ($january as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">February 2017</h3>";
                foreach ($february as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">March 2017</h3>";
