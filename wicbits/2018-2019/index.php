...
<body>
    ...
    <div class="wicbits-page">
        <div class="section">
            ...
            <h2>WicBits 2018-2019</h2>
            <div class="wicbits-section">
                <?php
                $directory = "";
                $root = "../../wicbits/2018-2019";
                ...
                echo "<h3 class=\"wicbits-month\">September 2018</h3>";
                foreach ($september as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">October 2018</h3>";
                foreach ($october as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                // echo "<h3 class=\"wicbits-month\">November 2018</h3>";
                // foreach ($november as $file)
                // {
                //     echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                // }

                echo "<h3 class=\"wicbits-month\">December 2018</h3>";
                foreach ($december as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">January 2019</h3>";
                foreach ($january as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">February 2019</h3>";
                foreach ($february as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">March 2019</h3>";
                foreach ($march as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">April 2019</h3>";
            ...
            <div class="wicbits-temp-space"></div>
        </div>
    </div>
